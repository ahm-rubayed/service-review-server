...
async function run() {
    try {
        const serviceCollection = client.db('proShooter').collection('services')
        ...
        app.get('/addservice', async (req, res) => {
            const query = {}
            const cursor = customServiceCollection.find(query);
...
app.get("/", (req, res) => {
    res.send("ProShoot server is running")
})

app.listen(port, () => {
    console.log(`ProtShoot server is running on port ${port}`)
})
